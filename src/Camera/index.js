...
var Camera = React.forwardRef(function (_a, ref) {
        ...
        return {
            takePhoto: function (type) {
                ...
                if (canvas === null || canvas === void 0 ? void 0 : canvas.current) {
                    var playerWidth =
                        ((_a = player === null || player === void 0 ? void 0 : player.current) === null || _a === void 0 ? void 0 : _a.videoWidth) || 1280;
                    var playerHeight =
                        ((_b = player === null || player === void 0 ? void 0 : player.current) === null || _b === void 0 ? void 0 : _b.videoHeight) || 720;
                    var playerAR = playerWidth / playerHeight;
                    var canvasWidth =
                        ((_c = container === null || container === void 0 ? void 0 : container.current) === null || _c === void 0 ? void 0 : _c.offsetWidth) ||
                        1280;
                    var canvasHeight =
                        ((_d = container === null || container === void 0 ? void 0 : container.current) === null || _d === void 0 ? void 0 : _d.offsetHeight) ||
                        1280;
    ...
    useEffect(
        function () {
            switchTorch(false).then(function (success) {
                return setTorchSupported(success);
            });
...
var shouldSwitchToCamera = function (currentFacingMode) {
    return __awaiter(void 0, void 0, void 0, function () {
        var cameras;
                ...
                case 0:
                    ...
                    return [
                        ...
                        navigator.mediaDevices.enumerateDevices().then(function (devices) {
                            var videoDevices = devices.filter(function (i) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (
                        (_a = navigator === null || navigator === void 0 ? void 0 : navigator.mediaDevices) === null || _a === void 0 ? void 0 : _a.getUserMedia
                    ) {
